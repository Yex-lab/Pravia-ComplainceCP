...
const MuiInputBase: Components<Theme>['MuiInputBase'] = {
  ...
  styleOverrides: {
    ...
    input: ({ theme }) => ({
      ...
      variants: [...(inputBaseVariants.input as any[]), ...multilineInputVariants],
    }),
  },
};
...
const MuiOutlinedInput: Components<Theme>['MuiOutlinedInput'] = {
  ...
  styleOverrides: {
    ...
    input: { variants: [...(outlinedInputVariants.input as any[]), ...multilineInputVariants] },
...
export const filledInputStyles = {
  root: (theme: Theme, classes: Partial<FilledInputClasses>): CSSObject => {
    const baseBg = varAlpha(theme.vars.palette.grey['500Channel'], 0.12);
    const hoverBg = varAlpha(theme.vars.palette.grey['500Channel'], 0.20);
...
export const filledInputVariants: {
  ...
  root: [
    ...
    {
      props: (props: any) => !!props.multiline && !!props.hiddenLabel,
      style: { ...INPUT_PADDING.filled.mediumHidden },
    },
    {
      props: (props: any) => !!props.multiline && !!props.hiddenLabel && props.size === 'small',
...
const MuiFilledInput: Components<Theme>['MuiFilledInput'] = {
  ...
  styleOverrides: {
    ...
    input: {
      variants: [...(filledInputVariants.input as any[]), ...multilineInputVariants],
    },
  },
};
