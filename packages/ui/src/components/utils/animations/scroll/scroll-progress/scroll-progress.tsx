...
import type { PaletteColorKey } from '@asyml8/ui/theme';
...
export function ScrollProgress({
  ...
  // Safety check: if progress is undefined, return null
  if (!progress) {
    console.warn('ScrollProgress: progress prop is undefined');
    return null;
  }
