...
import { Label, ICONS, Iconify, Scrollbar, SearchNotFound } from '@asyml8/ui';
...
export function Searchbar({ data: navItems = [], onNavigate, sx, ...other }: SearchbarProps) {
      ...
      {dataFiltered.map((item) => {
        ...
        return (
          <MenuItem 
            ...
            onClick={() => {
              console.log('MenuItem clicked:', item.path);
              if (onNavigate) {
        ...
        <InputBase
          ...
          startAdornment={
            <InputAdornment position="start">
              <Iconify icon={ICONS.SEARCH} width={24} sx={{ color: 'text.disabled' }} />
            </InputAdornment>
          }
